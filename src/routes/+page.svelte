		...
		>
			<div
				class={isFormExpanded
					...
					: 'pointer-events-auto flex h-[min(92vh,62.4rem)] max-h-[92vh] w-full max-w-4xl min-h-0 flex-col overflow-hidden rounded-lg border border-warm-200 bg-white shadow-2xl'}
				onclick={(e) => {
